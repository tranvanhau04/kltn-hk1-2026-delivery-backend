...
-- 3. BẢNG ĐIỂM TẬP KẾT / KHO HÀNG (DEPOTS)
CREATE TABLE `depots` (
    `id` VARCHAR(36) PRIMARY KEY,
...
-- 4. BẢNG CA LÀM VIỆC CỦA TÀI XẾ (SHIFTS)
CREATE TABLE `shifts` (
    `id` VARCHAR(36) PRIMARY KEY,
...
-- 6. BẢNG LỊCH SỬ TRẠNG THÁI ĐƠN HÀNG (ORDER_STATUS_HISTORIES)
...
CREATE TABLE `routes` (
    ...
    `total_estimated_time_min` DECIMAL(8, 2) DEFAULT 0.00,
...
-- 8. BẢNG ĐIỂM DỪNG GIAO HÀNG (STOPS)
CREATE TABLE `stops` (
    `id` VARCHAR(36) PRIMARY KEY,
...
-- 9. BẢNG XÁC NHẬN GIAO HÀNG (PROOF_OF_DELIVERIES - POD)
...
-- 10. BẢNG LOG TỌA ĐỘ GPS REALTIME (TRACKING_LOGS)
...
-- 11. BẢNG BÁO CÁO & ĐỐI SOÁT TỔNG HỢP (REPORTS)
...
-- 3. ĐIỂM TẬP KẾT / KHO TRUNG CHUYỂN CHẶNG CUỐI (DEPOTS)
...
-- 4. CA LÀM VIỆC TÀI XẾ (SHIFTS)
INSERT INTO `shifts` (`id`, `driver_id`, `start_time`, `end_time`, `status`, `cod_collected`, `cod_submitted`) VALUES
('shift000-0000-0000-0000-000000000001', 'u0000000-0000-0000-0000-000000000101', '2026-08-31 07:30:00', NULL, 'OPEN', 1150000.00, 0.00),
('shift000-0000-0000-0000-000000000002', 'u0000000-0000-0000-0000-000000000102', '2026-08-31 08:00:00', NULL, 'OPEN', 820000.00, 0.00),
('shift000-0000-0000-0000-000000000003', 'u0000000-0000-0000-0000-000000000103', '2026-08-31 07:45:00', NULL, 'OPEN', 1950000.00, 0.00),
('shift000-0000-0000-0000-000000000004', 'u0000000-0000-0000-0000-000000000104', '2026-08-31 08:15:00', NULL, 'OPEN', 0.00, 0.00),
('shift000-0000-0000-0000-000000000005', 'u0000000-0000-0000-0000-000000000105', '2026-08-31 08:30:00', NULL, 'OPEN', 0.00, 0.00),
('shift000-0000-0000-0000-000000000006', 'u0000000-0000-0000-0000-000000000106', '2026-08-31 08:30:00', NULL, 'OPEN', 0.00, 0.00);

-- 5. DANH SÁCH ĐƠN HÀNG (30 ĐƠN HÀNG ĐỦ CÁC TRẠNG THÁI VÀ KHU VỰC)
INSERT INTO `orders` (`id`, `code`, `dispatcher_id`, `receiver_name`, `receiver_phone`, `delivery_address`, `latitude`, `longitude`, `weight_kg`, `volume_m3`, `cod_amount`, `status`) VALUES
-- Tuyến 1 (Gò Vấp - Tài xế 1 xe máy):
('ord00000-0000-0000-0000-000000000001', 'ORD-20260831-001', 'u0000000-0000-0000-0000-000000000002', 'Chị Mai Linh', '0918111222', '45 Lê Đức Thọ, Phường 7, Gò Vấp, TP.HCM', 10.8385200, 106.6789100, 1.20, 0.005, 350000.00, 'DELIVERED'),
('ord00000-0000-0000-0000-000000000002', 'ORD-20260831-002', 'u0000000-0000-0000-0000-000000000002', 'Anh Tuấn Anh', '0938333444', '120 Phan Văn Trị, Phường 10, Gò Vấp, TP.HCM', 10.8289100, 106.6743200, 3.50, 0.012, 500000.00, 'DELIVERED'),
('ord00000-0000-0000-0000-000000000003', 'ORD-20260831-003', 'u0000000-0000-0000-0000-000000000002', 'Bác Minh Tâm', '0988555666', '88 Quang Trung, Phường 11, Gò Vấp, TP.HCM', 10.8351000, 106.6621000, 0.80, 0.003, 300000.00, 'DELIVERED'),
('ord00000-0000-0000-0000-000000000004', 'ORD-20260831-004', 'u0000000-0000-0000-0000-000000000002', 'Cô Bích Ngọc', '0977888999', '215 Thống Nhất, Phường 15, Gò Vấp, TP.HCM', 10.8492000, 106.6678000, 2.10, 0.008, 280000.00, 'RESCHEDULED'),
('ord00000-0000-0000-0000-000000000005', 'ORD-20260831-005', 'u0000000-0000-0000-0000-000000000002', 'Anh Hữu Phước', '0944111333', '56 Nguyễn Oanh, Phường 17, Gò Vấp, TP.HCM', 10.8412000, 106.6798000, 5.00, 0.020, 0.00, 'FAILED'),
('ord00000-0000-0000-0000-000000000006', 'ORD-20260831-006', 'u0000000-0000-0000-0000-000000000002', 'Nguyễn Thu Thủy', '0903112233', '72 Dương Quảng Hàm, Phường 5, Gò Vấp, TP.HCM', 10.8315000, 106.6901000, 1.10, 0.004, 190000.00, 'IN_TRANSIT'),
('ord00000-0000-0000-0000-000000000007', 'ORD-20260831-007', 'u0000000-0000-0000-0000-000000000002', 'Trần Văn Bình', '0908334455', '310 Cây Trâm, Phường 8, Gò Vấp, TP.HCM', 10.8431000, 106.6542000, 2.80, 0.010, 450000.00, 'IN_TRANSIT'),

-- Tuyến 2 (Bình Thạnh - Tài xế 2 xe máy):
('ord00000-0000-0000-0000-000000000008', 'ORD-20260831-008', 'u0000000-0000-0000-0000-000000000002', 'Đỗ Quỳnh Chi', '0966778899', '89 Phan Đăng Lưu, Phường 7, Phú Nhuận, TP.HCM', 10.8002000, 106.6891000, 0.50, 0.002, 650000.00, 'DELIVERED'),
('ord00000-0000-0000-0000-000000000009', 'ORD-20260831-009', 'u0000000-0000-0000-0000-000000000002', 'Nguyễn Thị Hoa', '0912334455', '34 Bạch Đằng, Phường 24, Bình Thạnh, TP.HCM', 10.8015000, 106.7082000, 1.50, 0.006, 170000.00, 'DELIVERED'),
('ord00000-0000-0000-0000-000000000010', 'ORD-20260831-010', 'u0000000-0000-0000-0000-000000000002', 'Hoàng Văn Đông', '0933445566', '125 Nơ Trang Long, Phường 14, Bình Thạnh, TP.HCM', 10.8112000, 106.6954000, 4.20, 0.015, 0.00, 'IN_TRANSIT'),
('ord00000-0000-0000-0000-000000000011', 'ORD-20260831-011', 'u0000000-0000-0000-0000-000000000002', 'Lê Khánh Huyền', '0979112244', '48 Ung Văn Khiêm, Phường 25, Bình Thạnh, TP.HCM', 10.8033000, 106.7175000, 2.00, 0.008, 520000.00, 'IN_TRANSIT'),
('ord00000-0000-0000-0000-000000000012', 'ORD-20260831-012', 'u0000000-0000-0000-0000-000000000002', 'Phan Văn Hưng', '0981223355', '200 Xô Viết Nghệ Tĩnh, Phường 21, Bình Thạnh, TP.HCM', 10.7961000, 106.7103000, 3.10, 0.011, 310000.00, 'ASSIGNED'),

-- Tuyến 3 (Hàng nặng/cồng kềnh Q1 & Q3 - Xe Van 500kg):
('ord00000-0000-0000-0000-000000000013', 'ORD-20260831-013', 'u0000000-0000-0000-0000-000000000003', 'Công Ty TNHH Sao Mai', '02838221144', '65 Lê Lợi, Phường Bến Nghé, Quận 1, TP.HCM', 10.7745000, 106.7011000, 45.00, 0.220, 1200000.00, 'DELIVERED'),
('ord00000-0000-0000-0000-000000000014', 'ORD-20260831-014', 'u0000000-0000-0000-0000-000000000003', 'Cửa Hàng Điện Máy ABC', '02839332211', '140 Nam Kỳ Khởi Nghĩa, Phường Bến Thành, Quận 1, TP.HCM', 10.7761000, 106.6965000, 75.00, 0.380, 750000.00, 'DELIVERED'),
('ord00000-0000-0000-0000-000000000015', 'ORD-20260831-015', 'u0000000-0000-0000-0000-000000000003', 'Văn Phòng Luật Sư Trí Đức', '0909556677', '220 Hai Bà Trưng, Phường Tân Định, Quận 1, TP.HCM', 10.7892000, 106.6923000, 30.00, 0.150, 0.00, 'IN_TRANSIT'),
('ord00000-0000-0000-0000-000000000016', 'ORD-20260831-016', 'u0000000-0000-0000-0000-000000000003', 'Showroom Nội Thất Minh Long', '0917889900', '18 Cách Mạng Tháng 8, Phường Bến Thành, Quận 1, TP.HCM', 10.7715000, 106.6918000, 95.00, 0.550, 2400000.00, 'IN_TRANSIT'),

-- BỘ 14 ĐƠN HÀNG MỚI (NEW) ĐANG CHỜ CHẠY THUẬT TOÁN VRP ĐỂ TỐI ƯU & PHÂN BỔ TUYẾN:
('ord00000-0000-0000-0000-000000000017', 'ORD-20260831-017', 'u0000000-0000-0000-0000-000000000002', 'Trần Thị Thu Hà', '0908776655', '50 Hoàng Văn Thụ, Phường 9, Phú Nhuận, TP.HCM', 10.7995000, 106.6778000, 2.00, 0.007, 310000.00, 'NEW'),
('ord00000-0000-0000-0000-000000000018', 'ORD-20260831-018', 'u0000000-0000-0000-0000-000000000002', 'Phạm Quỳnh Nga', '0931224466', '12 Phan Xích Long, Phường 2, Phú Nhuận, TP.HCM', 10.7965000, 106.6902000, 1.80, 0.006, 260000.00, 'NEW'),
('ord00000-0000-0000-0000-000000000019', 'ORD-20260831-019', 'u0000000-0000-0000-0000-000000000002', 'Lê Thành Đạt', '0945667788', '24 Nguyễn Thượng Hiền, Phường 1, Gò Vấp, TP.HCM', 10.8175000, 106.6899000, 0.90, 0.003, 150000.00, 'NEW'),
('ord00000-0000-0000-0000-000000000020', 'ORD-20260831-020', 'u0000000-0000-0000-0000-000000000002', 'Ngô Kiến Huy', '0967889900', '180 Lê Quang Định, Phường 14, Bình Thạnh, TP.HCM', 10.8105000, 106.6961000, 3.20, 0.012, 420000.00, 'NEW'),
('ord00000-0000-0000-0000-000000000021', 'ORD-20260831-021', 'u0000000-0000-0000-0000-000000000002', 'Vũ Thảo My', '0989001122', '95 Chu Văn An, Phường 26, Bình Thạnh, TP.HCM', 10.8122000, 106.7054000, 1.40, 0.005, 590000.00, 'NEW'),
('ord00000-0000-0000-0000-000000000022', 'ORD-20260831-022', 'u0000000-0000-0000-0000-000000000002', 'Huỳnh Lập', '0913557799', '15 Đinh Bộ Lĩnh, Phường 24, Bình Thạnh, TP.HCM', 10.8041000, 106.7099000, 4.00, 0.018, 0.00, 'NEW'),
('ord00000-0000-0000-0000-000000000023', 'ORD-20260831-023', 'u0000000-0000-0000-0000-000000000003', 'Đặng Thu Thảo', '0902887766', '36 Lý Tự Trọng, Phường Bến Nghé, Quận 1, TP.HCM', 10.7778000, 106.7018000, 1.00, 0.004, 380000.00, 'NEW'),
('ord00000-0000-0000-0000-000000000024', 'ORD-20260831-024', 'u0000000-0000-0000-0000-000000000003', 'Nguyễn Cao Kỳ Duyên', '0937112233', '88 Pasteur, Phường Bến Nghé, Quận 1, TP.HCM', 10.7749000, 106.7001000, 2.50, 0.009, 850000.00, 'NEW'),
('ord00000-0000-0000-0000-000000000025', 'ORD-20260831-025', 'u0000000-0000-0000-0000-000000000003', 'Trần Tiểu Vy', '0972445566', '110 Nguyễn Thị Minh Khai, Phường 6, Quận 3, TP.HCM', 10.7781000, 106.6914000, 1.20, 0.004, 210000.00, 'NEW'),
('ord00000-0000-0000-0000-000000000026', 'ORD-20260831-026', 'u0000000-0000-0000-0000-000000000003', 'Võ Hoàng Yến', '0919665544', '250 Võ Thị Sáu, Phường Võ Thị Sáu, Quận 3, TP.HCM', 10.7865000, 106.6872000, 5.50, 0.022, 670000.00, 'NEW'),
-- Các đơn hàng cồng kềnh chờ xe tải 1 tấn gom chuyến:
('ord00000-0000-0000-0000-000000000027', 'ORD-20260831-027', 'u0000000-0000-0000-0000-000000000004', 'Siêu Thị Điện Máy Xanh Q12', '02837155666', '100 Trường Chinh, Phường Tân Hưng Thuận, Quận 12, TP.HCM', 10.8398000, 106.6215000, 180.00, 1.100, 8500000.00, 'NEW'),
('ord00000-0000-0000-0000-000000000028', 'ORD-20260831-028', 'u0000000-0000-0000-0000-000000000004', 'Kho Vật Tư Tân Bình', '02838445566', '55 Cộng Hòa, Phường 4, Quận Tân Bình, TP.HCM', 10.8012000, 106.6558000, 250.00, 1.450, 12000000.00, 'NEW'),
('ord00000-0000-0000-0000-000000000029', 'ORD-20260831-029', 'u0000000-0000-0000-0000-000000000004', 'Đại Lý Phân Phối Sữa Thủ Đức', '02837223344', '15 Võ Văn Ngân, Phường Linh Chiểu, TP. Thủ Đức, TP.HCM', 10.8512000, 106.7621000, 320.00, 1.800, 15800000.00, 'NEW'),
('ord00000-0000-0000-0000-000000000030', 'ORD-20260831-030', 'u0000000-0000-0000-0000-000000000004', 'Công Ty Thiết Bị Y Tế Hòa Bình', '0903998877', '80 Tô Hiến Thành, Phường 15, Quận 10, TP.HCM', 10.7765000, 106.6632000, 120.00, 0.850, 4900000.00, 'NEW');
...
-- 10. NHẬT KÝ TỌA ĐỘ GPS (TRACKING_LOGS CHO NHIỀU XE CHẠY THỰC TẾ)
INSERT INTO `tracking_logs` (`id`, `driver_id`, `latitude`, `longitude`, `timestamp`) VALUES
-- Xe 1 (Tài xế Ngô Văn Tài - Khu vực Gò Vấp):
('log00000-0000-0000-0000-000000000001', 'u0000000-0000-0000-0000-000000000101', 10.8222050, 106.6874980, '2026-08-31 08:00:00'),
('log00000-0000-0000-0000-000000000002', 'u0000000-0000-0000-0000-000000000101', 10.8301000, 106.6830000, '2026-08-31 08:20:00'),
('log00000-0000-0000-0000-000000000003', 'u0000000-0000-0000-0000-000000000101', 10.8385200, 106.6789100, '2026-08-31 08:35:00'),
('log00000-0000-0000-0000-000000000004', 'u0000000-0000-0000-0000-000000000101', 10.8289100, 106.6743200, '2026-08-31 08:55:00'),
('log00000-0000-0000-0000-000000000005', 'u0000000-0000-0000-0000-000000000101', 10.8351000, 106.6621000, '2026-08-31 09:15:00'),
('log00000-0000-0000-0000-000000000006', 'u0000000-0000-0000-0000-000000000101', 10.8492000, 106.6678000, '2026-08-31 09:30:00'),
('log00000-0000-0000-0000-000000000007', 'u0000000-0000-0000-0000-000000000101', 10.8412000, 106.6798000, '2026-08-31 09:55:00'),
('log00000-0000-0000-0000-000000000008', 'u0000000-0000-0000-0000-000000000101', 10.8330000, 106.6850000, '2026-08-31 10:15:00'),

-- Xe 2 (Tài xế Phạm Hoàng Nam - Khu vực Bình Thạnh):
('log00000-0000-0000-0000-000000000009', 'u0000000-0000-0000-0000-000000000102', 10.7983450, 106.7118230, '2026-08-31 08:15:00'),
('log00000-0000-0000-0000-000000000010', 'u0000000-0000-0000-0000-000000000102', 10.8002000, 106.6891000, '2026-08-31 08:45:00'),
